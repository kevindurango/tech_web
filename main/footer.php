...
<section class="bg-dark text-white py-5 separator-line">
    <div class="container">
        <div class="row align-items-left">
            ...
            <div class="col-md-6">
                <form class="d-flex">
                    <input type="email" class="form-control me-0 no-border-radius" placeholder="your email...." aria-label="Email">
                    <button class="btn btn-danger no-border-radius" type="submit">
...
<footer class="bg-dark text-white py-5 footer separator-line">
    <div class="container">
        <div class="row">
            ...
            <!-- Column 1: Social Media & Logo -->
            <div class="col-md-3 mb-4">
                <!-- Logo Container -->
                <div class="logo-container text-left mb-3">
                    <img src="/tech_web/assets/tech-logo-non.png" alt="Company Logo" class="img-fluid justify-content-left" style="max-width: 150px;">
                </div>
            ...
            <div class="col-md-3">
                <h5>About Us</h5>
                <p class="text-white">
                    We are a team of passionate people whose goal is to improve everyone's life through products. We build great products to solve your business problems.
...
<footer class="bg-dark text-white py-1">
    <div class="container">
        ...
        <div class="col-12 col-md-6 mb-2 mb-md-0 d-flex align-items-center justify-content-center justify-content-md-start">
                ...
                <span class="ms-2" style="font-size: 1rem;">Copyright © MyCompany</span>
            </div>
